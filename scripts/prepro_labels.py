...
if __name__ == "__main__":
    ...
    dataset_output_path = os.path.join(basic_path, output_path)
    output_h5_path = os.path.join(basic_path, output_h5)

    parser = argparse.ArgumentParser()

    # input json
    parser.add_argument('--input_json', default=dataset_caption_path,
                        help='input json file to process into hdf5')
    parser.add_argument('--output_json', default=dataset_output_path, help='output json file')
    parser.add_argument('--output_h5', default=output_h5_path, help='output h5 file')
    ...
    parser.add_argument('--word_count_threshold', default=word_count_threshold, type=int,
