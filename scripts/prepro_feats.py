...
if __name__ == "__main__":
  ...
  parser.add_argument('--output_dir', default='data/inception', help='output h5 file')
  ...
  parser.add_argument('--model', default='inception', type=str, help='resnet101, resnet152')
