...
def main(params):
  ...
  for i,img in enumerate(imgs):
    ...
    I = preprocess(I)
    with torch.no_grad():
      # tmp_fc, tmp_att = my_densenet(I, params['att_size'])
...
if __name__ == "__main__":
  ...
  # input json
  parser.add_argument('--input_json', default='data/cocotalk.json', help='input json file to process into hdf5')
  parser.add_argument('--output_dir', default='data/resnet101', help='output h5 file')
