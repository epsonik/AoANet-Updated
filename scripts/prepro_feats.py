...
if __name__ == "__main__":
  ...
  parser.add_argument('--output_dir', default='data/densenet161', help='output h5 file')
  ...
  parser.add_argument('--model', default='densenet161', type=str, help='resnet101, resnet152')
